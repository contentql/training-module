  ...
  return (
    <Box sx={{ ml: 10, mr: 10, mb: 4 }}>
      ...
      <Typography sx={{ color: 'text.secondary' }}>
        ...
        by third parties. Clients and students also need to periodically check for changes to our
        privacy policy as the company will not inform any client of any privacy policy changes other
