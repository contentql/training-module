import RyzolveLogo from './RyzolveLogo';

const Certificate = () => (
  <div className="absolute top-[calc(50%_-_397px)] left-[calc(50%_-_561.5px)] w-[1123px] h-[794px] text-left text-41xl text-black font-montaga">
        ...
        <div className="flex flex-col items-start justify-start gap-[18px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[14px]">
            <div className="relative leading-[120%] capitalize inline-block w-[511px]">
              ...
              <p className="m-0">of Internship</p>
            </div>
          ...
          <div className="flex flex-col items-start justify-start gap-[17px] text-26xl text-darkslateblue font-montserrat">
            <div className="relative font-semibold">Naveen Chakka</div>
            <div className="relative text-mini leading-[135%] font-medium text-dimgray inline-block w-[461px]">
              For his/her outstanding completion of the compulsory internship program at ContentQL
        ...
        <div className="flex flex-row items-end justify-start gap-[71px] text-base text-darkslategray font-montserrat">
          <div className="flex flex-col items-start justify-start gap-[14px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[4px]">
              <div className="relative leading-[135%] font-semibold">AKHIL</div>
          ...
          <div className="flex flex-col items-start justify-start gap-[14px]">
            ...
            <img className="relative w-[117px] h-px" alt="" src="/vector-10.svg" />
            <div className="flex flex-col items-start justify-start gap-[4px]">
              <div className="relative leading-[135%] font-semibold">Naveen</div>
          ...
          <div className="flex flex-col items-start justify-start gap-[4px]">
            <div className="relative leading-[135%] font-semibold">04.02.2022</div>
